...
if(isset($_SESSION["login"])&&(!$_SESSION['reference'])){
        ...
        <div class="container">
            <div class="row">
                <div class="navbar-header col-xs-3 col-sm-3 col-md-2">
                    ...
                    <a class="navbar-brand hidden-xs" href="../iTransdata/" style="margin-top:69px;" title="iTrans DATA"><img src="img/iTrans_logo.png" height="130"></a>
                    <a class="navbar-brand hidden-sm hidden-md hidden-lg" href="../iTransdata/" style="margin-top:-2px;" title="iTrans DATA"><img src="img/iTrans_logo.png"  height="76"></a>
                </div>
                ...
                <div class="col-xs-9 col-sm-9 col-md-10">
                    <div class="collapse navbar-collapse" id="main-menu">
                        <ul itemscope="" itemtype="http://www.schema.org/SiteNavigationElement" class="nav navbar-nav navbar-right nav-main">
                            <li itemprop="name"><a itemprop="url" class="navbar-link active" href="" title="Home">Home</a></li>
                            <li itemprop="name"><a itemprop="url" class="navbar-link " href="#gm-home-3" title="Services">Services</a></li>
                            ...
                            <li class="mob-nav-language"><a href="Index.htm" title="Change Language" data-toggle="modal" data-target="#ModalLanguageMobile"><span class="flag-box"><svg class="gm-flag flag-ENG"><use xlink:href="#flag-ENG"></use></svg></span> Change Language                            </a></li>
                        </ul>
              ...
              <div class="container">
                  <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 ">
                        ...
                        <h3>Sorry, there was a problem funding that number.<br/> Send us a message to resolve that issue.<img src="img/whatsapp.png" height="25" width="25"> </h3>
                        
                          <a href="https://api.whatsapp.com/text?=" class="btn" title="Message Us via Whatsapp">Message Us</a>
                      </div>
                      <a href="dashboard/index.php" class="btn" title="Back to Profile">Back to your account</a>
                      </div>
                      <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 ">
...
<div id="gm-home-4" class="gh4" style="background: url(img/unlimited-data-plans.jpg) no-repeat 50% 0; background-size:100%; ">
    <div class="container">
        <br /> <br /> <br /> <br /> <br /> <br /> <br /> 
        <a href="login/index.htm" title="Recharge Now" class="btn btn-default">Recharge Now</a>
    </div>
</div>
      ...
      <div class="container">
            <div class="row">
                ...
                <div class="col-xs-6 col-md-6 col-md-pull-6 gm-footer-copyright">
                        <a class="footer-home" style="margin-top:82px;" href="" title="iTrans DATA"><img src="img/iTrans_logo.png" width="100"></a>
