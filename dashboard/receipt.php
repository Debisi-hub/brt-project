...
if(isset($_SESSION["login"])&&(empty($_SESSION['receipt']))){
              ...
              <div class="container">
                  <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 ">
                        ...
                        <tr><th>RECEIPT INFO</th></tr>
                        <tr><td>Email: </td><td><?=$_SESSION['umail'];?></td></tr>
                        <tr><td>Reference ID: </td><td><?=$_SESSION['uref'];?></td></tr>
                        <tr><td>Bus Route: </td><td><?=$_SESSION['ubusroute'];?></td></tr>
                        <tr><td>Duration: </td><td><?=$_SESSION['utime'];?></td></tr>
                        <tr><td>Cost: </td><td><?=$_SESSION['ucost'];?></td></tr>
                        <tr><td>Date: </td><td><?=$_SESSION['udate'];?></td></tr>
                       

</table>
                       <a href="" onclick="window.print()"
 class="btn" title="Click here to print"> Print </a> <br/>
